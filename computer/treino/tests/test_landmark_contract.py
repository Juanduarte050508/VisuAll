"""Trava o lado Python no contrato de computer/tests/fixtures/landmark_contract.json.
...
As tres funcoes cobertas vivem em computer/treino/ porque cada uma nasceu onde
era usada; o que as une e serem gemeas de LibrasMath.kt:
...
class TestContratoLandmarks(unittest.TestCase):
    ...
    def test_guarda_de_escala_bate_com_o_kotlin(self):
        ...
        fonte = (
            REPO / "mobile" / "app" / "src" / "main" / "java" / "com" / "visuall"
