...
if len(X_all) == 0:
    ...
    # Counter em vez de (y==l).sum(): com y vazio a comparação numpy vira um
    # escalar (não array), e .sum() quebra com AttributeError (mesmo bug já
    # corrigido em extract_from_videos.py).
