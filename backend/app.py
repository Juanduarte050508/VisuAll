...
>>> COLOQUE NESTA PASTA, junto deste arquivo:
    modelo_mlp_estatico.pkl, letras_mlp_estatico.pkl
    modelo_mlp.pkl, letras_mlp.pkl
...
try:
    modelo_estatico  = carrega_pickle(P("modelo_mlp_estatico.pkl"))
    classes_estatico = carrega_pickle(P("letras_mlp_estatico.pkl"))
...
try:
    modelo_mlp  = carrega_pickle(P("modelo_mlp.pkl"))
    classes_mlp = carrega_pickle(P("letras_mlp.pkl"))
