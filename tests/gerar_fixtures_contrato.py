...
Uso:  python tests/gerar_fixtures_contrato.py
"""
import json
import sys
...
def main():
    fixtures = {
        "_leia_me": (
            ...
            "Gerado por tests/gerar_fixtures_contrato.py. Nao edite na mao, e nao "
            "regere so pra fazer teste passar -- ver docstring do gerador."
        ),
